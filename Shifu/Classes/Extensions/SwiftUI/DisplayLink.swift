...
//  Shifu
//
//  Created by Baoli Zhai on 2022/6/24.
//
...
extension SwiftUI.View {
    ...
    public func onEnterFrame(isActive: Bool = true, displayLink: DisplayLink = .shared, _ action: @escaping (DisplayLink.Frame) -> Void) -> some View {
